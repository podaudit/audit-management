...
<body>
	...
	<div class="container">
		...
		<h1 class="m-5 text-center display-3" style="color:#213963; font-family: 'Hammersmith One', sans-serif;" >Project Details</h1>
			...
			<div class="form-group">
				...
				<form:form modelAttribute="auditType">
					...
					<input type="submit" class="btn btn-primary btn-block mt-3"
						value="Submit" style="background-color:#1eae98;">
				</form:form>
			</div>
